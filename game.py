...
class Game:
    ...
    def save(self):
        format_output("saving game...")
        with open(path.join("saveData", "bad.accidents"), "w+") as f:
            f.write(obj.current_game.current_room.fileName)
            f.close
        format_output("game saved.")
    ...
    def speak(self):
        format_output(obj.current_game.current_room.npc_interact)

    def read(self):
        format_output(obj.current_game.current_room.text)
